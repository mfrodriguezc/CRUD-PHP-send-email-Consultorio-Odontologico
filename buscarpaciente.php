...
if (isset($_POST ['buscar'])) {
    ...
    $citas = RepositorioCita :: mostrar_citas_paciente(Conexion:: obtener_conexion(), $validador->getId_paciente());
...
if (isset($_POST ['eliminar'])) {
   ...
   $paciente_eliminado = RepositorioPaciente :: eliminar_paciente(Conexion :: obtener_conexion(), $validador->getId_paciente());
